...
from routes.skill_graph import router as skill_graph_router  # RE-ENABLED: AI features disabled in service
...
app.include_router(skill_graph_router)  # RE-ENABLED: AI features disabled in service to prevent hang
