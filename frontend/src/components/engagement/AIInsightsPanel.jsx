...
const AIInsightsPanel = ({ insights, loading }) => {
  ...
  const { engagement_prediction, activity_patterns, comparison_with_similar_users } = insights;
          ...
          <CardContent className="pt-6 space-y-4">
            ...
            <div>
              <div className="flex justify-between text-sm mb-2">
                ...
                <span className="font-semibold">{Math.round(engagement_prediction.confidence * 100)}%</span>
              </div>
              <Progress value={engagement_prediction.confidence * 100} className="h-3" />
            </div>
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <span className="font-bold text-lg text-purple-600">
                  {engagement_prediction.predicted_score_7days} pts
                </span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-lg text-purple-600">
                  {engagement_prediction.predicted_score_30days} pts
                </span>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-br from-green-400 to-emerald-500 text-white mb-3">
                  <div>
                    <p className="text-3xl font-bold">{comparison_with_similar_users.percentile}</p>
              ...
              <div className="space-y-3">
                ...
                <div>
                  <p className="text-sm text-gray-600">
                    ...
                    <span className="font-bold ml-1">{comparison_with_similar_users.avg_score_similar_users}</span>
                  </p>
                </div>
              </div>
